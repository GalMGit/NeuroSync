...
public class RegisterRequest
{
    ...
    [MaxLength(20, ErrorMessage = "Username не должен иметь более 20 символов")]
    [MinLength(3, ErrorMessage = "Username не должен иметь менее 3 символов")]
    [Required(ErrorMessage = "Username не может быть пустым")]
    public string Username { get; set; }

    [MaxLength(20, ErrorMessage = "DisplayName не должен иметь более 20 символов")]
    [MinLength(3, ErrorMessage = "DisplayName не должен иметь менее 3 символов")]
